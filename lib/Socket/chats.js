...
const { DEFAULT_CACHE_TTLS, HISTORY_SYNC_PAUSED_TIMEOUT_MS, PROCESSABLE_HISTORY_TYPES } = require('../Defaults/index.js');
const { ALL_WA_PATCH_NAMES } = require('../Types/index.js');
const { SyncState } = require('../Types/State.js');
const { chatModificationToAppPatch, decodePatches, decodeSyncdSnapshot, encodeSyncdPatch, ensureLTHashStateVersion, extractSyncdPatches, generateProfilePicture, getHistoryMsg, isAppStateSyncIrrecoverable, isMissingKeyError, MAX_SYNC_ATTEMPTS, newLTHashState, processSyncAction } = require('../Utils/index.js');
const { makeMutex } = require('../Utils/make-mutex.js');
const processMessage = require('../Utils/process-message.js').default || require('../Utils/process-message.js');
const { buildTcTokenFromJid } = require('../Utils/tc-token-utils.js');
const { getBinaryNodeChild, getBinaryNodeChildren, isHostedLidUser, isHostedPnUser, isLidUser, isPnUser, jidDecode, jidNormalizedUser, reduceBinaryNodeToDictionary, S_WHATSAPP_NET } = require('../WABinary/index.js');
const { USyncQuery, USyncUser } = require('../WAUSync/index.js');
const { makeSocket } = require('./socket.js');
